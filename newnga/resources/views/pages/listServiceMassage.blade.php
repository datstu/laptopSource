            ...
            <div class="container">
                <div class="row">
                    <!-- blog grid -->
                        ...
                        <div class="post card-container col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="blog-post blog-grid date-style-2">
                                <div class="dez-post-media dez-img-effect shrink background-hover"> <a href="{{URL::to($value->post_id .'/bai-viet-'.$value->post_slug)}}"><img src="{{asset('public/uploads/post/'.$value->post_image)}}" style="max-height: 407px" alt="{{$value->post_desc}}"></a> </div>
                                <div class="dez-post-info">
                                    ...
                                    <div class="dez-post-meta ">
                                        <ul>
                                            ...
                                            <li class="post-author"><i class="fa fa-user"></i><a href="{{URL::to($value->post_id .'/bai-viet-'.$value->post_slug)}}">Lea Beauty</a> </li>
                    ...
                    <div class="search-not-found">
                        ...
                        <div class="not-found">Hãy thử sử dụng các từ khóa chung chung hơn</div>
                    </div>
                        <?php 
                    }
                    ?>
