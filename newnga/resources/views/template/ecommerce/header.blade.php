                        ...
                        <div class="navbar-nav mr-auto">
                           ...
                           --}}
                            ...
                            <a href="{{URL::to('/ve-chung-toi')}}" class="nav-item nav-link">Giới thiệu</a>
                             ...
                             {{-- <a href="{{URL::to('/danh-sach-san-pham')}}" class="nav-item nav-link">Dưới 3 triệu </a>
                             <a href="{{URL::to('/danh-sach-san-pham')}}" class="nav-item nav-link">Từ 3 đến 5 triệu </a>
                             <a href="{{URL::to('/danh-sach-san-pham')}}" class="nav-item nav-link">Từ 5 đến 7 triệu </a>
                             <a href="{{URL::to('/danh-sach-san-pham')}}" class="nav-item nav-link">Từ 7 đến 10 triệu </a>
                             <a href="{{URL::to('/danh-sach-san-pham')}}" class="nav-item nav-link">Trên 10 triệu </a> --}}
                        </div>
