                        ...
                        <div class="blog-post blog-single">
                            ...
                            <div class="dez-post-meta m-b20">
                                <ul>
                                    ...
                                    <li class="post-author"><i class="fa fa-user"></i>By <a href="#">Khỏe cùng Lea</a> </li>
                    ...
                    <div class="col-md-3">
                        <aside  class="side-bar" style="margin-top: 20px;">
                            ...
                            <div class="widget recent-posts-entry">
                                <?php if( $recentPost) {?>
                                <h4 class="widget-title">Tin mới nhât</h4>
                                <div class="widget-post-bx">
                                    @foreach ($recentPost as $item)
                                    <div class="widget-post clearfix">
                                        <div class="dez-post-media"> <img src="{{asset('public/uploads/post/'.$item->post_image)}}" width="200" height="143" alt="{{$item->post_title}}"> </div>
                                        <div class="dez-post-info">
                                            ...
                                            <div class="dez-post-meta">
                                                <ul>
                                                    <li class="post-author">By Lea</li>
                            ...
                            <div class="widget widget_categories">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{URL::to('/'.$item->category_id.'/danh-muc-'.$item->category_name)}}">{{$item->category_name}}</a> (1)</li>
                                    @endforeach
                                </ul>
                            </div>
                            <?php } ?>
