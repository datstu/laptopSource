            ...
            <div class="col-lg-8">
                <div class="product-detail-top">
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <?php if ($productDetail['price_old']) {
                                $price = (int)$productDetail['price'];
                                $priceOld = (int)$productDetail['price_old'];
                                $result =  100 - $price * 100 / $priceOld;
                            ?>
                                <div class="label-top ">- {{round($result)}}%</div>
                            <?php }
                            if ($productDetail['type'] == 2) {
                                echo '<div class="label-sales ">Xả</div>';
                            }
                            ?>
                        ...
                        <div class="col-md-7">
                            <div class="product-content">
                                ...
                                <div class="price">
                                    <h4>Giá:</h4>
                                    <p>{{number_format((int)$productDetail['price'])}}₫
                                        @if($productDetail['price_old'])
                                        <span>{{number_format((int)$productDetail['price_old'])}}₫</span>
                                        @endif
                            ...
                            <div class="product-item">
                                <div class="product-image">
                                    <a href="product-detail.html">
                                        <img style="max-height: 300px;min-height: 240px;" src="{{asset('public/uploads/product/'.$product->image)}}" alt="{{$product->productName}}">
                                    </a>
                                ...
                                <a href="{{URL::to('/chi-tiet-san-pham-'.$product->productID)}}">
                                    <div class="dez-info p-t20 ">
                                        <div class="m-b15 price">
                                            <strong class="item_new_price txt_20 left font">{{number_format($product->price)}}đ</strong>
                                        </div>
                ...
                <div class="sidebar-widget widget-slider">
                    <div class="sidebar-slider normal-slider">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img style="max-height: 320px;min-height: 320px;" src="{{asset('public/uploads/product/'.$product->image)}}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="{{URL::to('/chi-tiet-san-pham-'.$product->productID)}}"><i class="fa fa-heart"></i></a>
                            ...
                            <a href="{{URL::to('/chi-tiet-san-pham-'.$product->productID)}}">
                                <div class="dez-info p-t20 ">
                                    ...
                                    <h2 class="  name_product">
                                        <div class="item_name font"><?php echo $product->moTaNgan ?></div>
                                    </h2>
                                    <div class=" rate font txt_16">
                                        <div class="block_star start_small">
                                            <div style="width:96%;" class="number_start"> </div>
