...
?>
                    ...
                    switch(trim($uri)){
                        ...
                        case '/danh-sach-san-pham': $activeMenu = 1; break;
                        case '/tra-cuu-don-hang': $activeMenu = 2; break;
                        case '/ve-chung-toi': $activeMenu = 3; break;
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="{{URL::to('/ve-chung-toi')}}" class="nav-item nav-link <?php echo ($activeMenu == 3)?'active':''; ?>">Giới thiệu</a>
                             ...
                             {{-- <a href="{{URL::to('/san-pham-theo-danh-16')}}" class="nav-item nav-link">Dưới 3 triệu </a>
                             <a href="{{URL::to('/san-pham-theo-danh-16')}}" class="nav-item nav-link">Từ 3 đến 5 triệu </a>
                             <a href="{{URL::to('/san-pham-theo-danh-16')}}" class="nav-item nav-link">Từ 5 đến 7 triệu </a>
                             <a href="{{URL::to('/san-pham-theo-danh-16')}}" class="nav-item nav-link">Từ 7 đến 10 triệu </a>
                             <a href="{{URL::to('/san-pham-theo-danh-16')}}" class="nav-item nav-link">Trên 10 triệu </a> --}}
                        </div>
