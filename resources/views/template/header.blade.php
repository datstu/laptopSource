            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="dez-topbar-right">
                        <ul>
                            <li><i class="fa fa-envelope-o m-r5"></i> ngathinkpad@gmail.com </li>
                            <li> <i class="fa fa-phone m-r5"></i> +(84) 779 444 222</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <?php
     $content = Cart::getContent();?>
                    ...
                    <div class="dez-quik-search bg-primary ">
                        <form action="{{URL::to('tim-kiem-bai-viet')}}" method="GET">
                            <input id="searchFocus" name="search" value="" type="text" class="form-control" autofocus placeholder="Nhập chủ đề...">
